    ...
    public class CategoryRepository
    {
        public bool Add(Category category)
        {
            ...
            try
            {
                ...
                string commandString = @"INSERT INTO Category(Code,Name,Detail) VALUES (" + category.Code + ",'" + category.Name + "','"+category.Detail+
"')";
        ...
        public bool Update(Category category)
        {
            try
            {
                ...
                string commandString = @"UPDATE Category SET Code = " + category.Code + ", Name = '" + category.Name + "', Detail = '" + category.Detail + "' WHERE Id = " + category.ID + "";
                SqlCommand sqlCommand = new SqlCommand(commandString, sqlConnection);
